...
class WPCom_Markdown {
  ...
  protected function load_markdown_for_comments() {
    ...
    // any munged HTML.
    /* TODO DAVID: This is how you can transform other markdown */
  ...
  public function add_default_post_type_support() {
    ...
    add_post_type_support( 'snippet', self::POST_TYPE_SUPPORT );
    add_post_type_support( 'portfolio', self::POST_TYPE_SUPPORT );
  ...
  public function transform( $text, $args = array() ) {
    ...
    // DAVIDS EDITS. Fix broken arrow functions
    $text = preg_replace( '/=&gt;/m', '=>', $text );
